...
ActiveRecord::Schema[7.1].define(version: 20_250_105_044_426) do
  ...
  create_table 'matches', force: :cascade do |t|
    ...
    t.index %w[user_id other_user_id], name: 'index_matches_on_user_id_and_other_user_id', unique: true
